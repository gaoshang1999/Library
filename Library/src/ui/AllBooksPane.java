...
public class AllBooksPane  {
	...
	public Pane initPane() {
        ...
        TableColumn copyNumberCol = new TableColumn("Total Number of Copy");
        TableColumn avalibleCol = new TableColumn("Avalible Number of Copy");
        ...
        avalibleCol.setCellValueFactory(
                new PropertyValueFactory<>("avalibleNumerOfCopy"));
        authorsCol.setCellValueFactory(
                new PropertyValueFactory<>("authors"));

        table.getColumns().clear();
        table.getColumns().addAll(isbnCol, titleCol, maxCheckoutLengthCol, copyNumberCol, avalibleCol, authorsCol);
